...
public class MainActivity extends AppCompatActivity {
    ...
    // keys use for passing data between activities
    ...
    public void onAdditem(View v) {
        ...
        etNewItem.setText("");
        writeItems();
        Toast.makeText(getApplicationContext(), "New Item added to list", Toast.LENGTH_SHORT).show();
    ...
    private void setupListViewListener() {
        ...
        lvItems.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                // crate the new activity
                Intent i = new Intent(MainActivity.this, EdditItemActivity.class);
